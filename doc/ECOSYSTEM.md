...
| Crate                | Parser            | Stream | no_std | Filter | Size   |
| -------------------- | ----------------- | ------ | ------ | ------ | ------ |
| `distill-strip-ansi` | 1B ECMA-48 FSM    | 1B     | yes    | yes    | ~100KB |
| `strip-ansi-escapes` | `vte` (Alacritty) | Writer | no     | no     | ~225KB |
| `fast-strip-ansi`    | `vt-push-parser`  | no     | no     | no     | ~140KB |
| `console`            | regex-based       | no     | no     | no     | ~500KB |
...
or zero-alloc clean-input fast paths.

## Sequence Coverage

| Sequence        | this crate    | strip-ansi-escapes | fast-strip-ansi |
| --------------- | ------------- | ------------------ | --------------- |
| CSI (`ESC [`)   | yes           | yes                | yes             |
