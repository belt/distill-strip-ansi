...
```toml
[dependencies]
strip-ansi = { package = "distill-strip-ansi", version = "0.6", default-features = false, features = ["filter"] }
```
...
```toml
[dependencies]
strip-ansi = { package = "distill-strip-ansi", version = "0.6", default-features = false, features = ["terminal-detect"] }
```
...
```toml
[dependencies]
strip-ansi = { package = "distill-strip-ansi", version = "0.6", default-features = false, features = ["transform"] }
```
...
```toml
[dependencies]
strip-ansi = { package = "distill-strip-ansi", version = "0.6", default-features = false, features = ["toml-config"] }
```
